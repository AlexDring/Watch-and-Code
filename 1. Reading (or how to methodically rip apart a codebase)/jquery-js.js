...
jQuery(function($) {
  ...
  var App = {
    ...
    render: function() {
      ...
      var todoList = document.getElementById("todo-list").innerHTML = this.todoTemplate(todos);
      ...
      var toggleAllCheck = document.getElementById('toggle-all');
      function toggleAll() {
        if (toggleAllCheck.checked = true) {
          this.getActiveTodos().length === 0;
        }
      }
      this.renderFooter();
      var todoFocus = document.getElementById("new-todo").focus();
      //$('#new-todo').focus();
    ...
    destroyCompleted: function() {
      ...
      this.filter = "all";
      this.render();
      console.log("destoryCompled " + this);
    },
